...
SELECT
  ...
  CASE
      WHEN ("Dispensing pharmacy U&C Price" - c.patient_pay_resp::decimal(10,2) / 100::decimal(3,0)) <= 0.01::decimal(3, 2) THEN TRUE
      ELSE FALSE
  END AS partial_paid_flag,
  CASE
      WHEN ("Dispensing pharmacy U&C Price" - c.patient_pay_resp::decimal(10,2) / 100::decimal(3,0)) <= 0.01::decimal(3, 2) THEN ("Administration Fee" * 0.9::decimal(2, 1))::decimal(5, 3)
      ELSE 4.0::decimal(5, 4)
  END AS rxpartner_margin
...
ORDER BY rxpartner_margin DESC
